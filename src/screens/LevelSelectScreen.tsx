...
export function LevelSelectScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-purple-50 px-3 sm:px-4 pb-8">
      {/* Header — tightened for 375px */}
      <div className="text-center mb-5 pt-5 sm:pt-6">
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                        {/* Level badge — icon + text so color isn't the only cue */}
                        <div
                          className={`
                        ...
                        >
                          {[1, 2, 3].map((star) => (
                            <span
                              ...
                              aria-hidden="true"
                              className={
                                star <= completion.starsEarned ? 'text-yellow-400' : 'text-gray-200'
                              }
                            >
                              ⭐
                            </span>
